...
<div class="page-content">
    <div class="content">
                    ...
                    <select style=" width: 188px; height: 35px; background-color: #5e5e5e" id="cate_pid"  name="cate_pid">
                        ...
                        @foreach($datas as $data)
                            <option value="{{$data->id}}"
                                @if($data->id == $article->cate_id ) selected
                                    @endif
                            >{{$data->name}}</option>
                        @endforeach
                    </select>
        ...
        <div class="layui-form-item">
            ...
            <td>
                <input type="text" class="layui-input" lay-verify="nikename" id="url" name="url" value="{{$article->url}}" style="width: 300px; ">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <img  alt="" id="urls" src="{{$article->url}}" style="width: 350px; height: 100px;">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="description" name="username" required="" lay-verify="nikename"
                       autocomplete="off" class="layui-input" value="{{$article->description}}">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" >
                ...
                <script id="editor" name="content" type="text/plain" style="width:900px;height:500px;">{!! $article->content !!}</script>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="author" name="username" required="" lay-verify="nikename"
                       autocomplete="off" class="layui-input" value="{{$article->author}}">
            </div>
        </div>
            </div>
            <div class="layui-form-item">
            ...
            $(".layui-btn").click(function (){
                ...
                if(title == ""){
                    ...
                    $.ajax({
                        ...
                        dataType: "json",
                        data: {
                            "id": id, "cate_id": cate_id, "title": title, "url": url, "tag": tag,
                            "description": description, "editor": editor, "author": author, "_token": "{{csrf_token()}}"
                        },
