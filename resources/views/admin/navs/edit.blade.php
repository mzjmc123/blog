        ...
        <!-- 右侧内容框架，更改从这里开始 -->
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="hidden" id="id" name="username" required="" lay-verify="nikename"
                           autocomplete="off" class="layui-input" value="{{$nav->id}}">

                    <input type="text" id="nav_name" name="username" required="" lay-verify="nikename"
                           autocomplete="off" class="layui-input" value="{{$nav->nav_name}}">
                </div>
            </div>
        <div class="layui-form-item">
            <label for="L_username" class="layui-form-label">
            ...
            <div class="layui-input-inline">
                <input type="text" id="nav_title" name="username" required="" lay-verify="nikename"
                       autocomplete="off" class="layui-input" value="{{$nav->nav_title}}">
            </div>
        </div>
        <div class="layui-form-item">
            <label for="L_username" class="layui-form-label">
            ...
            <div class="layui-input-inline">
                <input type="text" id="nav_url" name="username" required="" lay-verify="nikename"
                       autocomplete="off" class="layui-input" value="{{$nav->nav_url}}" style="width: 400px;" >
            </div>
        </div>
        <div class="layui-form-item">
            <label for="L_username" class="layui-form-label">
            ...
            <div class="layui-input-inline">
                <input type="text" id="nav_author" name="username" required="" lay-verify="nikename"
                       autocomplete="off" class="layui-input" value="{{$nav->nav_author}}">
            </div>
        </div>
            </div>
            <div class="layui-form-item">
...
<script>
    $(document).ready(function (){
            $(".layui-btn").click(function (){
                ...
                $.ajax({
                    type: "post",
                     url: "{{url('admin/navs/storg')}}",
                    dataType: "json",
                    data: {"id":id,"nav_name" : nav_name,"nav_title" : nav_title,"nav_url" :nav_url,"nav_author":nav_author,"_token":"{{csrf_token()}}"},
