        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="keywords" name="username" required="" lay-verify="nikename"
                       autocomplete="off" class="layui-input" value="" style="width: 400px;">
            </div>
        </div>
        <div class="layui-form-item">
            <label for="L_username" class="layui-form-label">
    ...
    $(document).ready(function (){
            $(".layui-btn").click(function (){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    data: {"cate_pid":cate_pid,"name" : name,"title" : title,"keywords" :keywords,"description":description,"author" :author,"_token":"{{csrf_token()}}"},
