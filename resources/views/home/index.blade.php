...
<link href="{{asset('home/css/animation.css')}}" rel="stylesheet">
<link href="{{asset('home/css/lrtk.css')}}" rel="stylesheet" />
...
<header>
	<nav id="nav">
    	<ul>
         ...
         <script src="{{asset('home/js/silder.js')}}"></script><!--获取当前页导航 高亮显示标题-->
    </nav>
</header>
...
<div id="mainbody">
	<div class="info">
        <figure>
            <img src="{{asset('home/images/art.jpg')}}" alt="秋。。。相知">
            <figcaption>
        ...
        <div class="card">
        	 <h1>我的名片</h1>
              <p>网名：Jeniffer | 含雪红梅</p>
              <p>职业：Web前端设计师、网页设计</p>
              <p>电话：18883397160</p>
              <p>Email：long_mu_fang@163.com</p>
              <ul class="linkmore">
        ...
        <ul class="bloglist">
            <li>
                <div class="row_box">
                    ...
                    <div class="ci"></div><!--圆形-->
                    <h2 class="title"> <a href="#">我希望爱情是这样的</a></h2>
                    <ul class="textinfo">
                        <a href="#"><img src="{{asset('home/images/s1.jpg')}}"></a>
                    ...
                    <ul class="details">
                        ...
                        <li class="icon_time"><a href="#">2015-1-9</a></li>
                    </ul>
                </div>
            </li>
    ...
    <!--右半部分开始-->
        <aside>
            ...
            <div class="toppic">
                <h2>图文并茂</h2>
                <ul>
                    <li><a href="#"><img src="{{asset('home/images/k01.jpg')}}">腐女不可怕，就怕腐女会画画！<p>伤不起</p></a> </li>
                    <li><a href="#"><img src="{{asset('home/images/k01.jpg')}}">问前任，你还爱我吗？无限戳中泪点~<p>感兴趣</p></a> </li>
                    <li><a href="#"><img src="{{asset('home/images/k01.jpg')}}">世上所谓幸福，就是一个笨蛋遇到一个傻瓜。<p>喜欢</p></a> </li>
                </ul>
            </div>
            <div class="clicks">
                <h2>热门点击</h2>
            ...
            <div class="viny">
                <dl>
                    <dt class="art"><img src="{{asset('home/images/artwork.png')}}" alt="专辑"></dt>
                    ...
                    <dd class="music"><audio src="{{asset('home/images/nf1.mp3')}}" controls loop></audio></dd>
                </dl>
            </div>
        </aside>
	</div>
...
<footer>
    <div class="foot-mid">
        ...
        <div class="visitors">
        	<h2>最新评论</h2>
            <dl>
            	<dt><img src="{{asset('home/images/s1.jpg')}}"></dt>
        ...
        <section class="flickr">
        	<h2>摄影作品</h2>
            <ul>
            	<li><a href="#"><img src="{{asset('home/images/20180208122905512.jpg')}}"></a></li>
            	<li><a href="#"><img src="{{asset('home/images/01.jpg')}}"></a></li>
            	<li><a href="#"><img src="{{asset('home/images/01.jpg')}}"></a></li>
            	<li><a href="#"><img src="{{asset('home/images/01.jpg')}}"></a></li>
            	<li><a href="#"><img src="{{asset('home/images/01.jpg')}}"></a></li>
            	<li><a href="#"><img src="{{asset('home/images/01.jpg')}}"></a></li>
